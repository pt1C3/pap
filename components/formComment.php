<form method="post" action="./auth/comment.php">
  <div style="margin-top:5vh;">
    ...
    <?php 
    if($_SESSION["id"] != $_GET["id"]) echo '<input type="hidden" value="'.$_GET["id"].'" name="profileID">';
    else if($_SESSION["id"] == $_GET["id"]) echo '<input type="hidden" value="'.$_SESSION["id"].'" name="profileID">';
    ?>
